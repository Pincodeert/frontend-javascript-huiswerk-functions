...
function getEmailDomain(emailAddress){
    const n = emailAddress.lastIndexOf("@");
    const domainName = emailAddress.substring(n);
    return domainName;
}
...
// * Er een @ in voorkomt
// * Er géén , in voorkomt
// * Er géén . in voorkomt als allerlaatste karakter (dus hotmail.com is valide, net als outlook.nl, maar
// outlooknl. niet)
// ---- Verwachte uitkomsten:
